                ...
                html.Div(className='row',
                    ...
                    html.Div(className='three columns div-explainers',
                            children=[
                                ...
                                html.H3(f"Recovery: {(viz.dataframe.cured/(viz.dataframe.sick+viz.dataframe.dead)).round(decimals=3).iloc[-1]*100} %"),
                                html.H3(f"Fatality: {(viz.dataframe.dead/(viz.dataframe.sick+viz.dataframe.cured)).round(decimals=3).iloc[-1]*100} %")
                            ])
                ]),
